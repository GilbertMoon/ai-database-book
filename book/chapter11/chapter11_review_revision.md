...
Chapter 11은 데이터베이스 보안과 백업의 기본을 입문 독자에게 설명하기 위한 1차 원고로 사용 가능한 수준입니다.
...
| Chapter 상태 문구 변경 | 완료 | `book/chapter11/chapter11.md` 상단 |
...
- 실습 환경에서는 CREATE ROLE, GRANT, REVOKE 명령의 실행 권한을 사전에 확인해야 한다.
```
...
```text
Chapter 11은 원고 1차 리뷰 및 보완 완료 상태로 전환되었다.
