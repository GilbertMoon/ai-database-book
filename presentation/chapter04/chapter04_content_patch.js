(() => {
  ...
  set('PRACTICE RULE', {
    ...
    s: `기본 실습은 번호 파일의 보호 검사까지 포함해 실행합니다. 공일 생성 파일과 공이 입력 파일은 전체 실행합니다. 베리파이 스튜던츠는 반복 실행할 수 있고, 공삼 조회 파일은 셀렉트별로 실행할 수 있습니다. 공사 파일은 시작 상태 검사를 먼저 통과한 뒤 업데이트와 딜리트 구간을 순서대로 진행합니다. 베이식 크러드 에스큐엘은 기존 링크용 통합 참고 파일입니다.`
  });
