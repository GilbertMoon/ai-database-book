(() => {
  ...
  function render() {
    ...
    if (root && navigation) navigation.applyFocus(root, slide, slideIndex, stepIndex, block);
  ...
  const auditIssues = navigation?.audit(slides, block) || [];
  if (auditIssues.length) console.warn('[Chapter05 audit]', auditIssues);
  render();
})();
