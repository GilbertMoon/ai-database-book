(() => {
  ...
  function render() {
    ...
    document.title = `${slideIndex + 1}/${slides.length} · ${window.CH7_TITLE || `Chapter 07 ${blockLabel} 강의`}`;
  }
  ...
  addEventListener('chapter07-slides-ready', boot, { once: true });
  addEventListener('chapter07-slides-error', () => {
    app.innerHTML = '<div class="loading-slide error-slide">Chapter 07 강의 계획서를 불러오지 못했습니다.</div>';
  }, { once: true });
  app.innerHTML = '<div class="loading-slide">Chapter 07 발표자료를 구성하는 중입니다.</div>';
  boot();
})();