...
| Chapter 11 | 데이터베이스 보안과 백업 | 원고 1차 확장 완료 / 실습 SQL 작성 완료 / 활동·실습 자료 작성 완료 / 도식 삽입 완료 |
...
| Chapter 11 원고 확장 | 완료 |
| Chapter 11 실습 SQL 파일 작성 | 완료 |
| Chapter 11 활동/실습 자료 작성 | 완료 |
| Chapter 11 도식 후보 정리 | 완료 |
| Chapter 11 Mermaid 도식 원본 작성 | 완료 |
| Chapter 11 SVG 도식 생성 | 완료 |
| Chapter 11 본문 그림 링크 및 캡션 삽입 | 완료 |
| Chapter 11 리뷰 체크리스트 작성 | 예정 |
