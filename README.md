...
| Chapter 03 | PostgreSQL과 DBeaver 실습 환경 구축 | 원고 1차 확장 완료 / 실습 SQL 작성 완료 / 활동 자료 작성 완료 / 도식 삽입 완료 |
...
| Chapter 03 원고 확장 | 완료 |
| Chapter 03 실습 SQL 파일 작성 | 완료 |
| Chapter 03 활동/실습 자료 작성 | 완료 |
| Chapter 03 도식 후보 정리 | 완료 |
| Chapter 03 Mermaid 도식 원본 작성 | 완료 |
| Chapter 03 SVG 도식 생성 | 완료 |
| Chapter 03 본문 그림 링크 및 캡션 삽입 | 완료 |
| Chapter 03 리뷰 체크리스트 작성 | 예정 |
...
```text
Chapter 03 리뷰 체크리스트를 작성하고, 원고 1차 리뷰 및 보완을 진행한다.
```
