...
| Chapter 12 | NoSQL 이해와 선택 기준 | 원고 1차 확장 완료 / 실습 SQL 작성 완료 / 활동·실습 자료 작성 완료 / 도식 삽입 완료 |
...
| Chapter 12 원고 확장 | 완료 |
| Chapter 12 실습 SQL 또는 NoSQL 예제 작성 | 완료 |
| Chapter 12 활동/실습 자료 작성 | 완료 |
| Chapter 12 도식 후보 정리 | 완료 |
| Chapter 12 Mermaid 도식 원본 작성 | 완료 |
| Chapter 12 SVG 도식 생성 | 완료 |
| Chapter 12 본문 그림 링크 및 캡션 삽입 | 완료 |
| Chapter 12 리뷰 체크리스트 작성 | 예정 |
