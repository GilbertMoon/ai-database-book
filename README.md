...
| Chapter 03 | PostgreSQL과 DBeaver 실습 환경 구축 | 원고 1차 확장 완료 / 실습 SQL 작성 완료 / 활동 자료 작성 완료 |
...
```text
Chapter 03 도식 후보를 정리하고, images/chapter03/에 사용할 이미지 목록을 설계한다.
```
