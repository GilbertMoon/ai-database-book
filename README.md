...
| Chapter 06 | 정규화와 좋은 테이블 설계 | 원고 1차 리뷰 및 보완 완료 |
...
| Chapter 14 | Vector DB와 RAG 기초 | 원고 1차 리뷰 및 보완 완료 |
| Chapter 15 | 최종 프로젝트 또는 최종 평가 | 원고 1차 확장 완료 / 최종 프로젝트·평가 자료 작성 완료 / 제출 템플릿 작성 완료 / 활동·실습 자료 작성 완료 / 도식 삽입 완료 |
...
| 저장소 생성 | 완료 |
| 집필 가이드 확인 | 완료 |
| Chapter 01~14 원고 1차 리뷰 및 보완 | 완료 |
| Chapter 15 원고 확장 | 완료 |
| Chapter 15 최종 프로젝트/평가 자료 작성 | 완료 |
| Chapter 15 제출 템플릿 작성 | 완료 |
| Chapter 15 활동/실습 자료 작성 | 완료 |
| Chapter 15 도식 후보 정리 | 완료 |
| Chapter 15 Mermaid 도식 원본 작성 | 완료 |
| Chapter 15 SVG 도식 생성 | 완료 |
| Chapter 15 본문 그림 링크 및 캡션 삽입 | 완료 |
| Chapter 15 리뷰 체크리스트 작성 | 예정 |
