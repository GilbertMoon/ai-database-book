...
| Chapter 15 | 최종 프로젝트 또는 최종 평가 | 원고 1차 확장 완료 / 최종 프로젝트·평가 자료 작성 완료 / 제출 템플릿 작성 완료 / 활동·실습 자료 작성 완료 |
...
```text
Chapter 15 도식 후보를 정리하고, images/chapter15/에 사용할 이미지 목록을 설계한다.
```
