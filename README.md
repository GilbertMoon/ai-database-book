...
| Chapter 02 원고 확장 | 완료 |
| Chapter 02 활동/실습 자료 작성 | 완료 |
| Chapter 02 도식 후보 정리 | 완료 |
| Chapter 02 Mermaid 도식 원본 작성 | 완료 |
| Chapter 02 SVG 도식 생성 | 완료 |
| Chapter 02 본문 그림 링크 및 캡션 삽입 | 완료 |
| Chapter 02 리뷰 체크리스트 작성 | 완료 |
| Chapter 02 리뷰 후 보완 반영안 작성 | 완료 |
| Chapter 02 본문 보완안 직접 반영 | 완료 |
