...
| Chapter 04 | 관계형 데이터베이스와 SQL 기초 | 원고 1차 확장 완료 / 실습 SQL 작성 완료 / 활동 자료 작성 완료 / 도식 삽입 완료 |
...
| Chapter 04 원고 확장 | 완료 |
| Chapter 04 실습 SQL 파일 작성 | 완료 |
| Chapter 04 활동/실습 자료 작성 | 완료 |
| Chapter 04 도식 후보 정리 | 완료 |
| Chapter 04 Mermaid 도식 원본 작성 | 완료 |
| Chapter 04 SVG 도식 생성 | 완료 |
| Chapter 04 본문 그림 링크 및 캡션 삽입 | 완료 |
| Chapter 04 리뷰 체크리스트 작성 | 예정 |
...
```text
Chapter 04 리뷰 체크리스트를 작성하고, 원고 1차 리뷰 및 보완을 진행한다.
```
