...
| Chapter | 제목 | 상태 |
| --- | --- | --- |
| Chapter 01 | AI 시대에 데이터베이스를 왜 배우는가 | 원고 1차 확장 완료 / 활동 자료 작성 완료 / 도식 삽입 완료 / 리뷰 체크리스트 작성 완료 / 보완 반영안 작성 완료 |
...
```text
chapter01.md에 용어 미리보기 박스와 활동 자료 연결 문구를 직접 삽입한다.
```
