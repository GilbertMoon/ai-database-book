...
| Chapter 13 | ChatGPT와 Codex로 DB 설계 검증하기 | 원고 1차 확장 완료 / 실습 SQL 작성 완료 / 활동·실습 자료 작성 완료 / 도식 삽입 완료 |
...
| Chapter 13 활동/실습 자료 작성 | 완료 |
| Chapter 13 도식 후보 정리 | 완료 |
| Chapter 13 Mermaid 도식 원본 작성 | 완료 |
| Chapter 13 SVG 도식 생성 | 완료 |
| Chapter 13 본문 그림 링크 및 캡션 삽입 | 완료 |
| Chapter 13 리뷰 체크리스트 작성 | 예정 |
