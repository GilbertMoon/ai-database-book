...
| Chapter 07 | 중간 프로젝트 또는 중간 평가 | 원고 1차 확장 완료 / SQL 템플릿 작성 완료 / 활동·평가 자료 작성 완료 / 도식 삽입 완료 |
...
| Chapter 07 중간 프로젝트 원고 확장 | 완료 |
| Chapter 07 SQL 템플릿 작성 | 완료 |
| Chapter 07 활동/평가 자료 작성 | 완료 |
| Chapter 07 도식 후보 정리 | 완료 |
| Chapter 07 Mermaid 도식 원본 작성 | 완료 |
| Chapter 07 SVG 도식 생성 | 완료 |
| Chapter 07 본문 그림 링크 및 캡션 삽입 | 완료 |
| Chapter 07 리뷰 체크리스트 작성 | 예정 |
