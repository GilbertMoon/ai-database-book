...
| Chapter 03 | PostgreSQL과 DBeaver 실습 환경 구축 | 원고 1차 확장 완료 / 실습 SQL 작성 완료 / 활동 자료 작성 완료 / 도식 후보 정리 완료 / Mermaid 원본 작성 완료 |
...
| Chapter 03 SVG 도식 생성 및 본문 삽입 | 예정 |
...
```text
Chapter 03 Mermaid 도식 원본을 SVG 이미지로 변환하고, Chapter 03 본문에 그림 링크와 캡션을 삽입한다.
```
