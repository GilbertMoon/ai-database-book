...
| Chapter 08 | JOIN과 집계 쿼리 | 원고 1차 확장 완료 / 실습 SQL 작성 완료 / 활동·실습 자료 작성 완료 / 도식 삽입 완료 |
...
| Chapter 08 원고 확장 | 완료 |
| Chapter 08 실습 SQL 파일 작성 | 완료 |
| Chapter 08 활동/실습 자료 작성 | 완료 |
| Chapter 08 도식 후보 정리 | 완료 |
| Chapter 08 Mermaid 도식 원본 작성 | 완료 |
| Chapter 08 SVG 도식 생성 | 완료 |
| Chapter 08 본문 그림 링크 및 캡션 삽입 | 완료 |
| Chapter 08 리뷰 체크리스트 작성 | 예정 |
