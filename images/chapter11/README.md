...
Chapter 11은 데이터베이스를 안전하게 보호하고, 장애나 실수 발생 시 복구할 수 있도록 준비하는 기본 원칙을 설명하는 장입니다. 따라서 도식은 **계정과 권한 구조, 최소 권한 원칙, GRANT/REVOKE 흐름, SQL Injection 방어, 백업/복구 흐름, AI 생성 보안·백업 명령 검토**를 초급자가 직관적으로 이해할 수 있도록 구성합니다.
...
- 사용자, 역할, 권한, 테이블의 관계가 초급자에게 직관적으로 전달되는가?
