...
| --- | --- | --- | --- | --- |
| 그림 1-1 | `ch01_01_storage_options.svg` | 데이터 저장 방식 선택 흐름 | 데이터 저장 방식 설명 | 파일·스프레드시트·데이터베이스의 빠른 선택 기준 요약 |
...
| 그림 1-6 | `ch01_06_storage_choice_matrix.svg` | 저장 방식 선택과 확장 흐름 | 독자용 정리·워크북 | 기본 저장소 선택과 특수 목적 계층 추가 검토 흐름 |
