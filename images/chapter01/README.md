...
| 그림 1-6 | `ch01_06_storage_choice_matrix.svg` | 저장 방식 선택 매트릭스 | 독자용 정리·워크북 | 단순성·사용자 수·관계·검색 기준으로 저장 방식 비교 |
