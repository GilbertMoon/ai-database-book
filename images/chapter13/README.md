...
Chapter 13은 AI가 생성한 ERD, 테이블 설계, SQL을 사람이 검토하고 수정하는 흐름을 설명하는 장입니다. 따라서 도식은 **AI 설계 검증 전체 흐름, ChatGPT와 Codex 역할 구분, 좋은 프롬프트 구조, ERD 검토 흐름, 나쁜 설계와 좋은 설계 비교, 제약조건 검증, information_schema 점검, Codex 오류 수정 루프**를 입문 독자가 직관적으로 이해할 수 있도록 구성합니다.
