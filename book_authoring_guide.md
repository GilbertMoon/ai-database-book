...
### 1.2 Chapter는 하나의 독립된 실습 단위다

각 Chapter는 독립된 글이면서도 하나의 실습 흐름으로 완결되어야 합니다.
...
이 구조를 유지하면 Chapter별로 일반 독자용 eBook 원고와 강의 활용 가능한 실습 자료를 동시에 만들 수 있습니다.
...
```text
- AI / 데이터 / 개발 실습형 교재
- 강의에도 활용 가능한 실습형 eBook
- 부트캠프 교재
- 기업 교육용 실습 교재
- 프로젝트 기반 실무 교재
- 실습 코드와 보조 자료를 함께 제공하는 책
```
...
```text
- 한 Chapter는 하나의 명확한 도달점을 가져야 한다.
