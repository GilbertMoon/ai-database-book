...
-- 질문과 답변 시각은 월별 분석이 가능하도록 2026년 1~5월에 분산합니다.
...
(
    ...
    TIMESTAMPTZ '2026-01-10 11:00:00+09'
),
(
    302, 101, 'Q-2026-002', 'ERD 관계 질문',
    '질문과 학습 자료 관계를 어떻게 표현하나요?',
    'answered',
    TIMESTAMPTZ '2026-02-15 10:00:00+09',
    TIMESTAMPTZ '2026-02-15 12:00:00+09'
),
(
    303, 102, 'Q-2026-003', '트랜잭션 오류 처리',
    '여러 INSERT 중 하나가 실패하면 어떻게 하나요?',
    'open',
    TIMESTAMPTZ '2026-03-20 10:00:00+09',
    TIMESTAMPTZ '2026-03-20 10:00:00+09'
),
(
    ...
    'answered',
    TIMESTAMPTZ '2026-04-10 10:00:00+09',
    TIMESTAMPTZ '2026-04-10 13:00:00+09'
),
(
    305, 103, 'Q-2026-005', '닫힌 질문 예시',
    '이미 해결된 질문입니다.',
    'closed',
    TIMESTAMPTZ '2026-05-05 10:00:00+09',
    TIMESTAMPTZ '2026-05-05 14:00:00+09'
);
...
(
    ...
    TIMESTAMPTZ '2026-01-10 10:30:00+09'
),
(
    402, 301, 203,
    '실제 요구사항을 쿼리로 검증하면서 두 개념을 비교해 보세요.',
    TIMESTAMPTZ '2026-01-10 10:50:00+09'
),
(
    403, 302, 202,
    '질문과 자료는 N:M이므로 연결 테이블을 둡니다.',
    TIMESTAMPTZ '2026-02-15 11:30:00+09'
),
(
    404, 304, 201,
    'WHERE, JOIN, ORDER BY 패턴과 실행 계획을 기준으로 인덱스를 검토합니다.',
    TIMESTAMPTZ '2026-04-10 12:30:00+09'
),
(
    405, 305, 203,
    '닫힌 질문의 추가 답변 허용 여부는 별도 정책이 필요합니다.',
    TIMESTAMPTZ '2026-05-05 13:30:00+09'
);
...
(
    ...
    TIMESTAMPTZ '2026-01-02 09:00:00+09'
),
(
    ...
    TIMESTAMPTZ '2026-01-03 09:00:00+09'
),
(
    ...
    TIMESTAMPTZ '2026-02-02 09:00:00+09'
),
(
    ...
    TIMESTAMPTZ '2026-03-02 09:00:00+09'
),
(
    ...
    TIMESTAMPTZ '2026-04-02 09:00:00+09'
),
(
    ...
    TIMESTAMPTZ '2025-12-01 09:00:00+09'
);
