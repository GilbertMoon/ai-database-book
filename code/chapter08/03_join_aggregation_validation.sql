...
-- ============================================================
-- 2. 전체 금액과 강의별 금액 합 비교
-- 둘 다 590000이어야 합니다.
-- ============================================================
SELECT SUM(paid_amount) AS detail_total_paid_amount
FROM course_project.enrollments;

SELECT SUM(total_paid_amount) AS grouped_total_paid_amount
FROM (
    SELECT
        course_id,
...
SELECT
    ...
    SUM(non_cancelled_paid_amount) AS grouped_non_cancelled_paid_amount
FROM (
    SELECT
        c.id,
...
-- ============================================================
-- 5. INNER JOIN 결과 행 수가 원본 신청 수와 같은지 확인
-- 기대 결과: 5
-- ============================================================
